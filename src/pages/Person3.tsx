...
const sendEmail = () => {
  ...
  const body =
    'Hi, My name is [Insert Name Here], a [Insert Year Here] year at UChicago looking to speak with someone from student counseling. I am seeking in-person care. I am available on [insert time availability here between 9am-5pm CST M-F]. I would love to begin next week if feasible. Thank you so much! [Insert Your Name Here]';
...
const Person3: React.FC = () => {
  ...
  const handleButtonClick = () => {
    setDisplayText('counselingfeedback@bsd.uchicago.edu \n \n \n Hi, My name is [Insert Name Here], a [Insert Year Here] year at UChicago looking to speak with someone from student counseling. \n \n I am seeking in-person care. I am available on [insert time availability here between 9am-5pm CST M-F]. \n \n I would love to begin next week if feasible. \n \n Thank you so much! \n \n [Insert Your Name Here]')
  };
